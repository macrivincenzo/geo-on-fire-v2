...
export function AnalysisProgressSection({
  ...
  // Use provided prompts (generated by AI-powered function in parent component)
  // No fallback - prompts should always be provided from the parent
  const displayPrompts = prompts.length > 0 ? [...prompts, ...customPrompts] : customPrompts;
