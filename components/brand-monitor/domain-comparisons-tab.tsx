    ...
    return (
      <div className="flex flex-col h-full">
        <Card className="rounded-none border-2 border-gray-200 dark:border-gray-700 p-6 bg-white dark:bg-gray-800 shadow-sm">
          <CardHeader>
<CardTitle className="text-2xl font-bold text-gray-900 dark:text-white">Domain Comparisons</CardTitle>
          ...
          <CardContent>
            <div className="text-center py-10 bg-gray-50 dark:bg-gray-800 rounded-none border-2 border-dashed border-gray-300 dark:border-gray-600">
              ...
              <p className="text-base font-semibold text-gray-700 dark:text-gray-100 mb-1">No brand domain citations found</p>
  ...
  return (
    <div className="flex flex-col h-full gap-6">
        ...
        <Card className="rounded-none border-2 border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 shadow-sm">
          <CardContent className="pt-6">
            <div className="text-center">
              ...
              <p className="text-xs uppercase tracking-wider text-gray-500 dark:text-gray-300 mt-2 font-semibold">Your Brand Domains</p>
              <p className="text-xs text-gray-400 dark:text-gray-300 mt-1">{totalBrandCitations} citations</p>
            </div>
          </CardContent>
        </Card>
        <Card className="rounded-none border-2 border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 shadow-sm">
          <CardContent className="pt-6">
            <div className="text-center">
              ...
              <p className="text-xs uppercase tracking-wider text-gray-500 dark:text-gray-300 mt-2 font-semibold">Competitor Domains</p>
              <p className="text-xs text-gray-400 dark:text-gray-300 mt-1">{totalCompetitorCitations} citations</p>
            </div>
          </CardContent>
        </Card>
        <Card className="rounded-none border-2 border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 shadow-sm">
          <CardContent className="pt-6">
            <div className="text-center">
              ...
              <p className="text-xs uppercase tracking-wider text-gray-500 dark:text-gray-300 mt-2 font-semibold">Your Share</p>
              <p className="text-xs text-gray-400 dark:text-gray-300 mt-1">of brand domain citations</p>
            </div>
          </CardContent>
        </Card>
      </div>
      ...
      <Card className="rounded-none border-2 border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 shadow-sm">
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              <CardTitle className="text-xl font-bold text-gray-900 dark:text-white">Top Cited Brand Domains</CardTitle>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-gray-200 dark:border-gray-600">
                    ...
                    <th className="text-left py-3 px-4 text-xs font-semibold text-gray-600 dark:text-gray-300 uppercase">Domain</th>
                    <th className="text-left py-3 px-4 text-xs font-semibold text-gray-600 dark:text-gray-300 uppercase">Brand</th>
                    <th className="text-right py-3 px-4 text-xs font-semibold text-gray-600 dark:text-gray-300 uppercase">Times Cited</th>
                    <th className="text-right py-3 px-4 text-xs font-semibold text-gray-600 dark:text-gray-300 uppercase">Share</th>
                  </tr>
                </thead>
                <tbody>
                  {brandDomainData.slice(0, 10).map((domain, index) => (
                    <tr key={domain.domain} className="border-b border-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50">
                      <td className="py-3 px-4 text-sm text-gray-600 dark:text-gray-300">{index + 1}</td>
                      <td className="py-3 px-4">
                        <div className="flex items-center gap-2">
                          <Globe className="w-4 h-4 text-gray-400 dark:text-gray-400" />
                      ...
                      <td className="py-3 px-4">
                        <Badge 
                          ...
                          className={domain.brand === 'yours' ? 'bg-blue-100 dark:bg-blue-900/50 text-blue-700 dark:text-blue-200' : 'bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-200'}
                        >
                          {domain.brand === 'yours' ? brandName : domain.brand}
                        </Badge>
                      </td>
                      <td className="py-3 px-4 text-right text-sm font-semibold text-gray-900 dark:text-white">{domain.timesCited}</td>
                      <td className="py-3 px-4 text-right text-sm text-gray-600 dark:text-gray-200">{domain.shareOfCitations}%</td>
                    </tr>
                  ))}
                </tbody>
              </table>
                  ...
                  <div key={`${domain.domain}-${page.url}`} className="border-2 border-gray-200 dark:border-gray-600 rounded-none p-4 hover:bg-gray-50 dark:hover:bg-gray-800">
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        {page.title && (
                          <p className="text-xs text-gray-600 dark:text-gray-200 mb-2">{page.title}</p>
                        )}
                      ...
                      <div className="text-right ml-4">
                        <p className="text-sm font-semibold text-gray-900 dark:text-white">{page.timesCited}</p>
      ...
      {chartData.length > 0 && (
        <Card className="rounded-none border-2 border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 shadow-sm">
          <CardHeader>
            <CardTitle className="text-xl font-bold text-gray-900 dark:text-white">Citation Share by Domain</CardTitle>
            <CardDescription className="text-sm text-gray-600 dark:text-gray-200 mt-1">
