...
export function CompanyCard({ 
  ...
  return (
    <Card className="p-6 bg-white border border-gray-200 overflow-hidden transition-colors hover:border-gray-300">
      <div className="flex">
        {/* Left side - Logo/Image Display */}
        <div className="relative w-80 h-48 overflow-hidden bg-gray-100 border border-gray-200">
            ...
            <div className="mb-4">
              ...
              <div className="grid grid-cols-3 gap-4">
                {identifiedCompetitors.map((competitor, idx) => (
                  <div
                    key={idx}
                    className="group relative bg-white border border-gray-200 p-4 hover:border-gray-300 transition-colors opacity-0 animate-fade-up"
                    style={{ 
              ...
              <div className="flex items-center gap-4 mt-6 pt-6 border-t border-gray-200">
                {onAddCompetitor && (
                  <button
                    ...
                    className="h-10 px-4 text-sm font-medium flex items-center gap-1 transition-colors bg-gray-200 text-gray-900 hover:bg-gray-300"
                  >
