  ...
  return (
    <nav className="hidden md:flex w-80 flex-shrink-0 animate-fade-in flex-col h-[calc(100vh-8rem)] ml-[-2rem] sticky top-8" style={{ animationDelay: '0.3s' }}>
      ...
      <div className="w-full flex flex-col justify-between flex-1">
        ...
        <div className="pt-4 pb-8 border-t-2 border-gray-200">
          <button
            onClick={onRestart}
            className="w-full text-left px-4 py-3 text-sm font-medium transition-colors rounded-none border-2 border-gray-200 bg-gray-100 text-gray-900 hover:bg-gray-200 flex items-center gap-2"
          >
