  ...
  return (
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              ...
              <Link
                href="/plans"
                className="inline-flex items-center justify-center px-8 py-4 text-base font-semibold text-gray-900 bg-white hover:bg-gray-50 border border-gray-300 rounded-lg transition-colors"
              >
                View Pricing
              </Link>
            </div>
          ...
          {/* Clean Stats Grid */}
          <div className="mt-20 grid grid-cols-2 lg:grid-cols-4 gap-8 py-12 border-t border-b border-gray-200">
            <div className="text-center">
              ...
              <div className="text-xs text-gray-500 mt-1">ChatGPT, Claude, Gemini, Perplexity</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-gray-900 mb-2">Real-time</div>
              <div className="text-sm font-medium text-gray-600">Live Analysis</div>
              <div className="text-xs text-gray-500 mt-1">Instant visibility tracking</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-gray-900 mb-2">100%</div>
              <div className="text-sm font-medium text-gray-600">Accurate</div>
              <div className="text-xs text-gray-500 mt-1">Competitor benchmarking</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-gray-900 mb-2">24/7</div>
              <div className="text-sm font-medium text-gray-600">Monitoring</div>
              <div className="text-xs text-gray-500 mt-1">SEO & GEO optimization</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {/* Free Trial */}
            <div className="bg-white p-8 border border-gray-200 transition-colors hover:border-gray-300">
              ...
              <Link
                href="/register"
                className="w-full inline-flex items-center justify-center px-6 py-3 text-base font-semibold text-gray-900 bg-white border border-gray-300 hover:bg-gray-50 transition-colors"
              >
                Start Free
              </Link>
            </div>
            ...
            <div className="bg-white p-8 border-2 border-blue-600 relative">
              <div className="absolute -top-3 left-1/2 transform -translate-x-1/2 bg-blue-600 text-white px-4 py-1 text-sm font-semibold">
                Most Popular
              </div>
              <h3 className="text-2xl font-bold text-gray-900 mb-2">Single Analysis</h3>
            ...
            {/* Credit Pack */}
            <div className="bg-white p-8 border border-gray-200 transition-colors hover:border-gray-300">
              <h3 className="text-2xl font-bold text-gray-900 mb-2">Credit Pack</h3>
          ...
          <div className="text-center mt-12">
            <Link href="/plans" className="text-blue-600 hover:text-blue-700 font-medium transition-colors">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 border border-gray-200">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Enter Your Website URL</h3>
            ...
            <div className="bg-white p-8 border border-gray-200">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">AI Models Analyze Your Brand</h3>
              <p className="text-gray-600">
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <span className="text-gray-700"><strong className="text-gray-900">Track AI Brand Rankings:</strong> See where your brand appears in AI responses across ChatGPT, Claude, Perplexity, Google Gemini, and more.</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-6 h-6 text-blue-600 mr-3 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <span className="text-gray-700"><strong className="text-gray-900">Monitor Competitor Performance:</strong> Understand how your competitors rank in AI search results and identify gaps.</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-6 h-6 text-blue-600 mr-3 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <span className="text-gray-700"><strong className="text-gray-900">Optimize for AI Search:</strong> Get specific recommendations to improve your AI brand visibility and GEO performance.</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-6 h-6 text-blue-600 mr-3 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <span className="text-gray-700"><strong className="text-gray-900">Real-time Monitoring:</strong> Track changes in your AI brand visibility over time and measure the impact of your optimization efforts.</span>
                </li>
              </ul>
            </div>
            <div className="bg-white p-12 border border-gray-200">
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-1">Multi-Platform AI Monitoring</h4>
                    <p className="text-gray-600 text-sm">Track your brand across ChatGPT, Claude, Perplexity, Gemini, and more AI platforms.</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="w-8 h-8 bg-blue-600 text-white flex items-center justify-center font-bold mr-4 flex-shrink-0">✓</div>
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">Compare your AI brand visibility against competitors and identify ranking opportunities.</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="w-8 h-8 bg-blue-600 text-white flex items-center justify-center font-bold mr-4 flex-shrink-0">✓</div>
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-1">AI Search Optimization</h4>
                    <p className="text-gray-600 text-sm">Get actionable insights to improve your AI search visibility and GEO performance.</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="w-8 h-8 bg-blue-600 text-white flex items-center justify-center font-bold mr-4 flex-shrink-0">✓</div>
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">Monitor your AI brand visibility score and track changes over time.</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-blue-600 p-8 sm:p-12 md:p-16 text-center border-2 border-blue-700">
