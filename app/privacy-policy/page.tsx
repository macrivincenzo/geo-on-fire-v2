        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <nav className="mb-8" aria-label="Breadcrumb">
            <ol className="flex items-center space-x-2 text-sm text-zinc-600">
              ...
              <li>/</li>
              <li className="text-zinc-900">Privacy Policy</li>
            </ol>
          </nav>
        ...
        <div className="prose prose-lg max-w-none">
          <div className="space-y-8 text-zinc-700">
            <section>
              ...
              <p className="leading-relaxed">
                AI Brand Track ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our <Link href="/brand-monitor" className="text-blue-600 hover:underline">AI brand visibility monitoring platform</Link>.
              </p>
            </section>
            ...
            <section>
              <h2 className="text-2xl font-bold text-zinc-900 mb-4">4. Information Sharing and Disclosure</h2>
              <p className="leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-zinc-900 mb-4">5. Data Security</h2>
              <p className="leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-zinc-900 mb-4">7. Cookies and Tracking Technologies</h2>
              <p className="leading-relaxed">
            ...
            <section>
              ...
              <p className="leading-relaxed">
                If you have any questions about this Privacy Policy, please contact us through our <Link href="/" className="text-blue-600 hover:underline">platform</Link> or email us at privacy@aibrandtrack.com.
              </p>
            </section>
          </div>
          ...
          <div className="mt-16 pt-8 border-t border-zinc-200">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <Link href="/terms-of-service" className="p-4 border border-zinc-200 rounded-lg hover:border-blue-600 transition-colors">
                <h3 className="font-semibold text-zinc-900 mb-2">Terms of Service</h3>
                <p className="text-sm text-zinc-600">Read our terms and conditions</p>
              </Link>
